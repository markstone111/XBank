...
public class ManagerDashboard extends javax.swing.JFrame {
    ...
    public ManagerDashboard(String eid) {
        ...
        if (db.rs.next()) {
        ename = db.rs.getString("E_NAME");  
        }
        }
        catch (Exception e) {
            e.printStackTrace(); // For debugging; replace with a user-friendly alert if required
        }   
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
        new UpdatePass(eid).setVisible(true);
        this.dispose();
